...
export abstract class HttpResponseBase {
    ...
    public readonly type !: HttpEventType.Response | HttpEventType.ResponseHeader;
...
export class HttpHeaderResponse extends HttpResponseBase {
    ...
    public readonly type: HttpEventType.ResponseHeader = HttpEventType.ResponseHeader;
    /**
     ...
     */
    public clone(update: { headers?: HttpHeaders; status?: number; statusText?: string; url?: string; } = {}):
        HttpHeaderResponse {
...
export class HttpResponse<T> extends HttpResponseBase {
    ...
    public readonly type: HttpEventType.Response = HttpEventType.Response;
